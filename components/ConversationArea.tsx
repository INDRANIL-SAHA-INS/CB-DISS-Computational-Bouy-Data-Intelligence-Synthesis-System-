          ...
          <div className="h-[60vh] sm:h-[65vh] overflow-y-auto p-4 sm:p-6 space-y-4 transition-all duration-500">
            {messages.length === 0 ? (
              ...
              messages.map((message) => (
                ...
                >
                  <div
                    className={
                      `max-w-[80%] rounded-lg px-4 py-3 break-words overflow-wrap-anywhere text-white border border-slate-700 bg-slate-800`
                    }
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-slate-800 text-white rounded-lg px-4 py-3 max-w-[80%] border border-slate-700 break-words overflow-wrap-anywhere" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>
