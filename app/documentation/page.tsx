...
const resources = [
  {
    ...
    description: 'Comprehensive guide to ARGO data management practices and standards.',
    type: 'PDF',
    size: '2.3 MB',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need to know about ARGO floats, data formats, and how to access and use the data.
            </p>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-center">Resources & Downloads</h2>
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-muted-foreground text-xs">{resource.size}</span>
                    </div>
                  </div>
          ...
          <div className="text-center">
            <div className="bg-card/90 backdrop-blur-md rounded-lg border border-border p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Can&apos;t find what you&apos;re looking for? Our AI assistant can help you navigate the documentation 
                and answer specific questions about ARGO data.
              </p>
